 ...
 */
public class TPVGLSurfaceView extends GLSurfaceView {

    //    protected final MyGLRenderer mRenderer;
    public final TPVGLRenderer mRenderer;
    public static Resources res;
    Double headingangle;

    public TPVGLSurfaceView(Context context) {
        super(context);
