...
public class AircraftModel {
    ...
    static float offY =-0.2f;
    static float squareCoords[] = {
            0.0f/scale,  1.0f/scale+offY, 0.0f/scale+offZ,   // 0
            -0.6f/scale, 0.0f/scale+offY, 0.0f/scale+offZ,   // 1
            -0.1f/scale, 0.0f/scale+offY, 0.0f/scale+offZ,   // 2
            0.0f/scale,  0.1f/scale+offY, -0.3f/scale+offZ,    //3
            0.1f/scale,   0.0f/scale+offY,   0.0f/scale+offZ,   //4
            0.6f/scale,    0.0f/scale+offY,   0.0f/scale+offZ  //5
    }; //
