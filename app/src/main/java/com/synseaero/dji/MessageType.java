...
public class MessageType {
    ...
    public static final int MSG_GET_PHOTO_RATIO = 100054;
    public static final int MSG_SET_PHOTO_RATIO = 100055;

    public static final int MSG_GET_PHOTO_FORMAT = 100056;
    public static final int MSG_SET_PHOTO_FORMAT = 100057;

    public static final int MSG_GET_PHOTO_WB_AND_CT = 100058;
    public static final int MSG_SET_PHOTO_WB_AND_CT = 100059;

    public static final int MSG_GET_VIDEO_R_AND_FR = 100060;
    public static final int MSG_SET_VIDEO_R_AND_FR = 100061;

    public static final int MSG_GET_VIDEO_FORMAT = 100062;
    public static final int MSG_SET_VIDEO_FORMAT = 100063;

    public static final int MSG_GET_VIDEO_STANDARD = 100064;
    public static final int MSG_SET_VIDEO_STANDARD = 100065;

    public static final int MSG_WATCH_CAMERA_STATUS = 100066;
    ...
    public static final int MSG_GET_PHOTO_RATIO_RESPONSE = 200054;
    public static final int MSG_SET_PHOTO_RATIO_RESPONSE = 200055;

    public static final int MSG_GET_PHOTO_FORMAT_RESPONSE = 200056;
    public static final int MSG_SET_PHOTO_FORMAT_RESPONSE = 200057;

    public static final int MSG_GET_PHOTO_WB_AND_CT_RESPONSE = 200058;
    public static final int MSG_SET_PHOTO_WB_AND_CT_RESPONSE = 200059;

    public static final int MSG_GET_VIDEO_R_AND_FR_RESPONSE = 2000060;
    public static final int MSG_SET_VIDEO_R_AND_FR_RESPONSE = 200061;

    public static final int MSG_GET_VIDEO_FORMAT_RESPONSE = 2000062;
    public static final int MSG_SET_VIDEO_FORMAT_RESPONSE = 200063;

    public static final int MSG_GET_VIDEO_STANDARD_RESPONSE = 200064;
    public static final int MSG_SET_VIDEO_STANDARD_RESPONSE = 200065;

    public static final int MSG_GET_CAMERA_STATUS_RESPONSE = 200066;
}
