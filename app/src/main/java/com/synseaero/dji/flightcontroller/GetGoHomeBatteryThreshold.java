...
public class GetGoHomeBatteryThreshold extends Task {


    public GetGoHomeBatteryThreshold(Bundle data, Messenger messenger) {
        ...
        if (product != null && product instanceof DJIAircraft) {
            ...
            flightController.getGoHomeBatteryThreshold(new DJICommonCallbacks.DJICompletionCallbackWith<Integer>() {
                ...
                public void onSuccess(Integer threshold) {
                    ...
                    message.what = MessageType.MSG_GET_GO_HOME_BATTERY_THRESHOLD_RESPONSE;
