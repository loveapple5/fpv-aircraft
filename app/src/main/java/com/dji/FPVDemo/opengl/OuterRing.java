...
public class OuterRing {
    ...
    static float offY = 0f;
    static float squareCoords[] = {
            -0.5f*scale, 0.8f+offY, 0.5f*scale,    // top left
            -0.5f*scale, 0.8f+offY,-0.5f*scale,    // bottom left
             0.5f*scale, 0.8f+offY,-0.5f*scale,    // bottom right
             0.5f*scale, 0.8f+offY, 0.5f*scale }; // top right
...
///////////////////////   loadTexture here  !!!  ///////////////////////////
        mTextureDataHandle0 = loadTexture(R.drawable.ring_02);
